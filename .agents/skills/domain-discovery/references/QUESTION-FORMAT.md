...
```
**Q: [Sharp, focused question, plain business language, no DDD jargon — keep every word in the language of the user's business]**
...
- **The recommendation's reason must be specific.** "It fits your constraints" is not a reason. Name the constraint.
